...
const facebookShare = () => {
  ...
  btnShareFbElm.setAttribute('href', `https://www.facebook.com/dialog/share?app_id=${appId}&display=popup&href=${encodeURIComponent(urlShare)}&redirect_uri=${encodeURIComponent(urlMain)}`)
